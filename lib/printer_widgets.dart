...
// company name
Widget compnayName() {
  return const Text('Mahmoud Ahmed', style: TextStyle(color: Colors.black, fontSize: 22, fontWeight: FontWeight.bold));
}

// branch name
Widget branchName() {
  return const Text('القاهره', style: TextStyle(color: Colors.black, fontSize: 22, fontWeight: FontWeight.bold));
}
...
Widget cashierNameAndPostingDate() {
  return Container(
    padding: const EdgeInsets.all(6),
    child: const Text('Mahmoud| 25-08-2023 13:52:12', style: TextStyle(color: Colors.black, fontSize: 18)),
  );
}
